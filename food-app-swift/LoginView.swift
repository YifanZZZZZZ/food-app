...
struct LoginView: View {
    ...
    private func pingServerBeforeLogin(completion: @escaping () -> Void) {
        guard let pingURL = URL(string: "https://food-app-recipe.onrender.com/ping") else {
            completion()
            return
        }
    ...
    private func attemptLogin() {
        ...
        guard let url = URL(string: "https://food-app-recipe.onrender.com/login") else { return }
