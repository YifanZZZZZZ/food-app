...
struct ExerciseTrackingView: View {
    ...
    func fetchExerciseData() {
        ...
        guard let url = URL(string: "https://food-app-swift.onrender.com/user-exercise?user_id=\(userId)") else { return }
    ...
    func addExercise() {
        ...
        guard let url = URL(string: "https://food-app-swift.onrender.com/add-exercise") else { return }
